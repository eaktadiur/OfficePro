...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle" media="screen">
            ...
            @import "../../Public/jquery-ui/css/ui-lightness/jquery-ui-1.8.16.custom.css";
        ...
        <script type="text/javascript" charset="utf-8" src="../../Public/JQuery-DataTables-Editable-1.3/media/js/jquery.validate.js"></script>
