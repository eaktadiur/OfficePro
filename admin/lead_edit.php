...
if (!empty($_POST) && $_POST["id"]) {
    ...
    if (count($errors) == 0) {
        ...
        $lead = new leadEdit($id, $fname, $lname, $address, $city_state_zip, $phone, $mobile, $fax, $tshirt_size, $email, $afname, $alname, $aemail, $arelation, $aphone, $atshirt_size, $loggedInUser->displayname, $event_type        );
                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Event Type: </td>
                            <td><input name="event_type" type="text" class="input-xlarge focused" id="t-shirt_size" value="<?php echo $leaddetails[0]['event_type']; ?>" /></td>
                        </tr>
                        <tr>
                            <td colspan="4">&nbsp;</td>
                        </tr>
